...
import { singleCategory } from '../apicall'
...
const Categorydetails = () => {
  ...
  const getCatwisedata = async () => {
    const response = await singleCategory(slug)
    console.log("Category wise data...", response)
    return response
  }

  const { isLoading, isError, data: catwisedata } = useQuery({
    queryKey: ['catwisedata', slug],
    queryFn: getCatwisedata
  })
