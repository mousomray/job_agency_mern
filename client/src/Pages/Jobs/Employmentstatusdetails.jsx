...
import { singleStatus } from '../apicall'
...
const Employmentstatusdetails = () => {
  ...
  const getSingledata = async () => {
    const response = await singleStatus(slug)
    console.log("Status wise data...", response)
    return response
  }

  const { isLoading, isError, data: statuswisedata } = useQuery({
    queryKey: ['statuswisedata', slug],
